...
public class HeapPage implements Page {
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        // How will this exception affect the HeapFile iterator (?)

        // Insert the tuple into the empty slot
        tuples[emptySlotIndex] = t;

        // Mark the slot as used
        markSlotUsed(emptySlotIndex, true);

        // Update the tuple's RecordId
    ...
    public Iterator<Tuple> iterator() {
        ...
        // Iterate through all slots and collect tuples in used slots
        for (int i = 0; i < numSlots; i++) {
            if (isSlotUsed(i)) { // Check if the slot is filled
                validTuples.add(tuples[i]); // Add the tuple to the list
            }
        }

        return new Iterator<Tuple>() {
            private final Iterator<Tuple> it = validTuples.iterator();
